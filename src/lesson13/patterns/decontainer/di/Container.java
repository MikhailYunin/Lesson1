package lesson13.patterns.decontainer.di;
            ...
            if (cls.isAnnotationPresent(Component.class)){
                ...
                for (Field field: fields){
                    if (field.isAnnotationPresent(AutoField.class)){
                        ...
                        Object o1 = field.getType().getDeclaredConstructor().newInstance(); // Cat cat = new Cat();
                        field.set(o, o1); // human.cat = cat;
                ...
                for (Method method: methods) {
                    if (method.isAnnotationPresent(AutoRun.class)){
                        ...
                        method.invoke(o);// для объекта вызывает метод
